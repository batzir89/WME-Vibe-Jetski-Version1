# `wz-h4` Component Specification

This document provides the specification for the Waze Styleguide `wz-h4` component, designed to allow AI systems to perfectly clone the visual and structural characteristics of the component.
...
:host {
  font-size: 20px;
  letter-spacing: var(--wz-letter-spacing, 0.15px);
}
