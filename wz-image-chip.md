# `wz-image-chip` Component Specification

This document provides the specification for the Waze Styleguide `wz-image-chip` component, designed to allow AI systems to perfectly clone the visual and structural characteristics of the component.
...
| `hasError` | `boolean` | `false` | Whether the chip in error state. |
| `imageSrc` | `string` | `null` | An image src for an avatar. |
...
render() {
        ...
        const shouldRenderAvatar = shouldRenderIcons && this.imageSrc;
        const shouldRenderText = hasDefaultSlot(this.el);
        const shouldRenderRemoveIcon = shouldRenderIcons && this.removable;
        const componentClass = {
            "with-avatar": Boolean(this.imageSrc),
            "wz-chip": true,
            [getChipClassBySize(this.size)]: true,
            "only-icons": !shouldRenderText,
        ...
        return (h("div", { key: 'd246008972cde8d7927387e26415812a7f4c21e9', tabIndex: 0, class: componentClass }, shouldRenderAvatar && h(ChipAvatar, { key: 'f6a7404d9ba62add244dbae11950848add75ed02', imageSrc: this.imageSrc }), h("slot", { key: 'e32446776e29fdb123877863ad954db36e618fc6', name: "icon" }), shouldRenderText && (h("span", { key: '03384b709121366653a979f07fdbf6ff3046bba2', class: "text" }, h("slot", { key: '0f01e5d2d6d94fe057fc6b9052f1acd6e7b635e0' }))), h("slot", { key: '7b9079c4bd8b5f3758a27e5d4bba57324d3b0121', name: "trailing-icon" }), shouldRenderRemoveIcon && (h(RemoveIcon, { key: '4e155615e3bda018018a442610999a9f0ed22107', onClick: this.removeClicked.emit }))));
    }
```
