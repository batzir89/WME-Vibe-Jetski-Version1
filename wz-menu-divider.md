# `wz-menu-divider` Component Specification

This document provides the specification for the Waze Styleguide `wz-menu-divider` component, designed to allow AI systems to perfectly clone the visual and structural characteristics of the component.
...
```javascript
render() {
        return h("div", { key: '586417088e0acb123fc4e5e180f7b078fe433c24', class: "wz-menu-option-divider" });
    }
```
