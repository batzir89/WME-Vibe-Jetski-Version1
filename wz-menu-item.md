# `wz-menu-item` Component Specification

This document provides the specification for the Waze Styleguide `wz-menu-item` component, designed to allow AI systems to perfectly clone the visual and structural characteristics of the component.

## 1. Overview & API
**Tag:** `wz-menu-item`
**Encapsulation:** `shadow`
**Dependencies:** `wz-caption`

### Properties
| Property | Type | Default | Description |
| :--- | :--- | :--- | :--- |
| `disabled` | `boolean` | `false` | Whether the current menu-item is disabled, |
| `helperText` | `string` | `""` | Helper text to show on the right side of the menu item, |
| `highlighted` | `boolean` | `false` | Whether the current menu-item should be highlighted, |

### Slots
| Slot | Description |
| :--- | :--- |
| `actions` | to show on element hover |
| `trailing-icon` | to be placed at the end of the component |
...
render() {
        ...
        return (h("div", { key: '0898fc1d9f3ca89cae0306e383023e6ef525bde2', class: componentClass }, h("div", { key: 'f6d12fe4933097195331806b094f89afd9c3ff6d', class: "content" }, h("slot", { key: '1dd1ed6ce10566de5142df8100a8cda90feed798' })), h("div", { key: 'df46c31086bf5c7d3685b60be11c46459376b347', class: "trailing" }, h("div", { key: '4a167924c2b8171e135b5d3498e8842a35de82a9', class: "actions" }, h("slot", { key: '8ab564e8855698d7615b4f9e13916ec2d9995a0e', name: "actions" })), h("slot", { key: '8b6480b0e6274447774bcaa51ab68d3dd001a6d0', name: "trailing-icon" }), this.helperText && (h("wz-caption", { key: '8c7b1a8ca3a70d50c172fb6dbded51d5ad5de6b2', class: "helper-text" }, this.helperText)))));
    }
```
