# `wz-menu-chip-base` Component Specification

This document provides the specification for the Waze Styleguide `wz-menu-chip-base` component, designed to allow AI systems to perfectly clone the visual and structural characteristics of the component.

## 1. Overview & API
**Tag:** `wz-menu-chip-base`
**Encapsulation:** `shadow`
**Dependencies:** `wz-menu`, `wz-checkable-chip`, `wz-menu-item`, `wz-text-input`
...
### Events
- `searchTermChanged`: Emits when interaction occurs
...
```javascript
render() {
        return (h("div", { key: '6504a7eed02fbbc74d4ccf37610e1f059088da56', class: "wz-menu-chip-wrapper" }, h(MenuChip, { key: 'cd7692b5107d2e870741ca26da78337a5721cf4d', displayName: this.displayName, isExpanded: this.expanded, isOptionSelected: this.isOptionSelected, controlled: true }, h("slot", { key: 'e8b59f59bbaa7730cd43224f86bd8805c706750b', name: "icon", slot: "icon" })), h("wz-menu", { key: '4608c959367feca9e341be4434baec2190cb60fc', tabindex: "-1", ref: (el) => (this.wzMenu = el), closeMenuOnClick: this.closeMenuOnClick, autoFocusOnOpen: false }, this.shouldAddSearch && (h(MenuChipSearchBar, { key: '14037941a5e96655b144cc8cd539dc6a3c613a5d', placeholder: this.searchPlaceholder, onSearchTermChanged: (term) => this.searchTermChanged.emit(term) })), h("slot", { key: 'a3c8c18ce1621dac8b59277878838b52737a8f7a', name: "menu-options" }))));
    }
```
...
.wz-menu-chip-icon {
  ...
  display: flex;
  height: 100%;
  padding-left: var(--space-always-xxs, 4px);
}
...
wz-menu-item.should-not-highlight-on-hover {
  --wz-menu-option-padding: 0 var(--space-always-s, 12px) var(--space-xs, 8px);
  --wz-menu-option-hover-color: var(--background_default, #ffffff);
}
```
