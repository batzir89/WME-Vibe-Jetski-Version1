# `wz-menu-sub-menu` Component Specification

This document provides the specification for the Waze Styleguide `wz-menu-sub-menu` component, designed to allow AI systems to perfectly clone the visual and structural characteristics of the component.

## 1. Overview & API
**Tag:** `wz-menu-sub-menu`
**Encapsulation:** `shadow`
**Dependencies:** `wz-badge`, `wz-menu`

### Properties
| Property | Type | Default | Description |
| :--- | :--- | :--- | :--- |
| `badgeContent` | `string` | `` | The sub menu item\'s badge content. |
| `controlled` | `boolean` | `false` | Whether the sub menu is controlled, opened with events and methods |
| `disabled` | `boolean` | `` |  |
| `subMenuTitle` | `string` | `` | The sub menu item's title. |
...
```javascript
render() {
        const innerMenuContentClass = {
            "options-wrapper": true,
            hidden: !this.expanded,
        };
        const innerMenuContent = (h("div", { key: '0d00f4fa132452dc86d64a47a72a43558c61895d', class: innerMenuContentClass, onMouseLeave: () => this.handleMouseLeave() }, h("wz-menu", { key: 'e981471c5e04e0c8b5af48c9c141ea2eaa0c6610', onBlur: (event) => event.stopPropagation(), autoFocusOnOpen: false, fixed: true, ref: (el) => (this.menuElement = el) }, h("slot", { key: 'f2ba1cc5bd201575414f94deae8146173c16f60a' }))));
        return (h("div", { key: '868dd99f10d1ce73bf97f5916809daf187e4f294', class: {
                "wz-menu-sub-menu ": true,
                disabled: this.disabled,
                expanded: this.expanded,
                timedOut: this.isTimedOut,
            }, onMouseEnter: (event) => this.handleMouseEnter(event), onMouseLeave: () => this.handleMouseLeave() }, h("slot", { key: '1358314d2f1fdf07aa0658fcdf75045a4a8e6eeb', name: "left-icon" }), h("span", { key: '1e006a8d7244d4f1fc36519922f6333e5f8b7df7', class: "content" }, this.subMenuTitle), h("span", { key: 'f3663b6a3d984efee2652e8608b0a11c9f22afd1', class: "badge" }, this.getBadge()), h("slot", { key: '800bbd2fea07c8e8266ebc1c7071ba0e70dd8a57', name: "right-icon" }), h("span", { key: '1c1e27bccdd4b96b360201370714e54a919ebe58', class: "icon" }, getCollapseRightIcon()), innerMenuContent));
    }
```
