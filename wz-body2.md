# `wz-body2` Component Specification

This document provides the specification for the Waze Styleguide `wz-body2` component, designed to allow AI systems to perfectly clone the visual and structural characteristics of the component.
...
:host {
  font-weight: 400;
  font-size: 14px;
  letter-spacing: var(--wz-letter-spacing, 0.25px);
  line-height: 22px;
}
